...
class Imerg_era5_binning:
    ...
    def load_files_compute_instab_subsat(self):
        ...
        self.bl = 0.5*(self.instab-self.subsat)
    ...
    def bin_imerg_1D(self):
        ...
        prc_bl_binned = self.__bin_prc(self.prc, self.bl, self.bl_bins)

        return prc_instab_binned, prc_subsat_binned, prc_bl_binned
